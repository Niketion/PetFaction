...
public class PetFollow_1_11_R1 implements PetFollow {
        ...
        new BukkitRunnable() {
            public void run() {
                try {
                    ...
                    ((EntityInsentient) petf).getAttributeInstance(GenericAttributes.MOVEMENT_SPEED).setValue(0.16000000298023224D);
